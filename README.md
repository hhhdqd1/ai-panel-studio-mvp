...
- 便于邮件阅读的 [核心 Prompt PDF](docs/submission/核心Prompt记录.pdf)、[一页工作流 PDF](docs/submission/开发流程与工作流说明.pdf) 与 [提交清单](docs/submission/提交清单.md) 均在 `docs/submission/`；Markdown 原件仍可编辑。
